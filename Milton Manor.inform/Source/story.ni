...
lamp is a thing. The description of lamp is "Two antique lamps that glow dimly and flicker with a ambiant light.". Lamp is scenery. lamp is in front porch.
...
instead of searching the mirror:
	say "you can see from here the dressar in the mirror.".
...
Knife is a thing.[ the location of Knife is under master bed.] The description of knife is "A sharp dagger, useful for combat, although in this instance it can be good for disembowlment." Knife is undescribed.

Main Bed is a supporter. Main Bed is undescribed. The description of Main bed is "A king sized bed, with the victim in it. A large pool of blood sorrounds the body.". Main Bed is scenery. Main Bed is in master bedroom.
...
Pictures are a thing. The description of pictures is "About seven pictures of the previous owners of milton manor. If memory serves correct (which it alwalys does) they are all ancestors of the victim.".
...
Suit of armor is a thing. The description of suit of armor is "A medival style suit-of-armor. It looks as if it is greased on a regular basis, for there is no rust and it still shines.".  Suit of armor is in Main hall. Suit of armor is undescribed.
instead of wearing the suit of armor:
	say "If no one is looking mabye we can try it on. 
	You then try on one arm and mabye a leg before you realize that it will never fit you."
Rug is a thing. "Persian rugs, made of the higest quality. The purpose is simple, to show off the extravagent lifestyle of the miltons.". rug is in main hall. Rug is undescribed.
...
[Go to front porch. In deck is code. Take code and examine it. Go to grandstaircase and open painting. "SPIN dial to 1539.
